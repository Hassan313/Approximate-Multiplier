...
module COMP4to2_16 ( X1, X2, X3, X4, Cin, Sum, Carry, Cout_BAR );
...
module COMP4to2_12 ( X1, X2, X3, X4, Sum, Carry, Cin_BAR, Cout_BAR );
  input X1, X2, X3, X4, Cin_BAR;
  output Sum, Carry, Cout_BAR;
  wire   Cin, n2, n3, n4, n5;
  assign Cin = Cin_BAR;
...
module COMP4to2_14 ( X1, X2, X3, X4, Sum, Carry, Cin_BAR, Cout_BAR );
  input X1, X2, X3, X4, Cin_BAR;
  output Sum, Carry, Cout_BAR;
  wire   Cin, n2, n3, n4, n5;
  assign Cin = Cin_BAR;
...
module dadda_8b_trunc_4b ( A, B, P );
  ...
  wire   co1, s1, co2, s2, cr2, co3, s3, cr3, co4, s4, co5, s5, cr5, co6, s6,
         ...
         cr11, co12, s12, co15, cr15, co16, s16, cr16, co17, s17, cr17, co18,
         s18, cr18, co19, s19, cr19, co20, s20, cr20, co21, s21, cr21, co22,
         s22, cr22, co23, s23, cr23, co24, s24, n6, n7, n8, n9, n10, n11, n12,
  ...
  HA_1 U49 ( .A(pp0[4]), .B(pp1[3]), .CO(co1), .S(s1) );
  COMP4to2_16 U50 ( .X1(pp0[5]), .X2(pp1[4]), .X3(pp2[3]), .X4(1'b0), .Cin(co1), .Sum(s2), .Carry(cr2), .Cout_BAR(co2) );
  COMP4to2_15 U51 ( .X1(pp0[6]), .X2(pp1[5]), .X3(pp2[4]), .X4(pp3[3]), .Sum(
        s3), .Carry(cr3), .Cin_BAR(co2), .Cout_BAR(co3) );
  HA_0 U52 ( .A(pp4[2]), .B(pp5[1]), .CO(co4), .S(s4) );
  COMP4to2_14 U53 ( .X1(pp0[7]), .X2(pp1[6]), .X3(pp2[5]), .X4(pp3[4]), .Sum(
        s5), .Carry(cr5), .Cin_BAR(co3), .Cout_BAR(co5) );
  COMP4to2_13 U54 ( .X1(pp4[3]), .X2(pp5[2]), .X3(pp6[1]), .X4(1'b0), .Cin(co4), .Cout(co6), .Sum(s6), .Carry(cr6) );
  COMP4to2_12 U55 ( .X1(pp1[7]), .X2(pp2[6]), .X3(pp3[5]), .X4(pp4[4]), .Sum(
        s7), .Carry(cr7), .Cin_BAR(co5), .Cout_BAR(co7) );
  COMP4to2_11 U56 ( .X1(pp5[3]), .X2(pp6[2]), .X3(pp7[1]), .X4(1'b0), .Cin(co6), .Cout(co8), .Sum(s8), .Carry(cr8) );
  COMP4to2_10 U57 ( .X1(pp2[7]), .X2(pp3[6]), .X3(pp4[5]), .X4(pp5[4]), .Sum(
        s9), .Carry(cr9), .Cin_BAR(co7), .Cout_BAR(co9) );
  FA_2 U58 ( .A(pp6[3]), .B(pp7[2]), .CI(co8), .CO(co10), .S(s10) );
  COMP4to2_9 U59 ( .X1(pp3[7]), .X2(pp4[6]), .X3(pp5[5]), .X4(pp6[4]), .Cout(
        co11), .Sum(s11), .Carry(cr11), .Cin_BAR(co9) );
  FA_1 U60 ( .A(pp4[7]), .B(pp5[6]), .CI(co11), .CO(co12), .S(s12) );
  COMP4to2_8 U63 ( .X1(s1), .X2(pp2[2]), .X3(pp3[1]), .X4(pp4[0]), .Cin(1'b0), 
        .Sum(P[4]), .Carry(cr15), .Cout_BAR(co15) );
  ...
  XOR2_X1 U79 ( .A1(s17), .A2(cr16), .Z(n27) );
  AND3_X1 U80 ( .A1(n27), .A2(s16), .A3(cr15), .Z(n6) );
  AOI21_X1 U81 ( .A1(cr16), .A2(s17), .B(n6), .ZN(n29) );
  XNOR2_X1 U82 ( .A1(s18), .A2(cr17), .ZN(n28) );
  NOR2_X2 U83 ( .A1(n29), .A2(n28), .ZN(n7) );
  AOI21_X1 U84 ( .A1(cr17), .A2(s18), .B(n7), .ZN(n31) );
  XNOR2_X1 U85 ( .A1(s19), .A2(cr18), .ZN(n30) );
  NOR2_X2 U86 ( .A1(n31), .A2(n30), .ZN(n8) );
  AOI21_X1 U87 ( .A1(cr18), .A2(s19), .B(n8), .ZN(n33) );
  XNOR2_X1 U88 ( .A1(cr19), .A2(s20), .ZN(n32) );
  NOR2_X2 U89 ( .A1(n33), .A2(n32), .ZN(n9) );
  AOI21_X1 U90 ( .A1(s20), .A2(cr19), .B(n9), .ZN(n17) );
  XNOR2_X1 U91 ( .A1(s21), .A2(cr20), .ZN(n16) );
  NOR2_X2 U92 ( .A1(n17), .A2(n16), .ZN(n10) );
  AOI21_X1 U93 ( .A1(cr20), .A2(s21), .B(n10), .ZN(n19) );
  XNOR2_X1 U94 ( .A1(s22), .A2(cr21), .ZN(n18) );
  NOR2_X2 U95 ( .A1(n19), .A2(n18), .ZN(n11) );
  AOI21_X1 U96 ( .A1(cr21), .A2(s22), .B(n11), .ZN(n21) );
  XNOR2_X1 U97 ( .A1(s23), .A2(cr22), .ZN(n20) );
  NOR2_X2 U98 ( .A1(n21), .A2(n20), .ZN(n12) );
  AOI21_X1 U99 ( .A1(cr22), .A2(s23), .B(n12), .ZN(n23) );
  XNOR2_X1 U100 ( .A1(s24), .A2(cr23), .ZN(n22) );
  NOR2_X2 U101 ( .A1(n23), .A2(n22), .ZN(n13) );
  AOI21_X1 U102 ( .A1(cr23), .A2(s24), .B(n13), .ZN(n14) );
  INV_X1 U103 ( .I(n14), .ZN(n25) );
  AOI22_X1 U104 ( .A1(co24), .A2(pp7[7]), .B1(n24), .B2(n25), .ZN(n15) );
  INV_X1 U105 ( .I(n15), .ZN(P[15]) );
  XOR2_X1 U106 ( .A1(n17), .A2(n16), .Z(P[10]) );
  XOR2_X1 U107 ( .A1(n19), .A2(n18), .Z(P[11]) );
  XOR2_X1 U108 ( .A1(n21), .A2(n20), .Z(P[12]) );
  XOR2_X1 U109 ( .A1(n23), .A2(n22), .Z(P[13]) );
  XOR2_X1 U110 ( .A1(n25), .A2(n24), .Z(P[14]) );
  XOR2_X1 U111 ( .A1(s16), .A2(cr15), .Z(P[5]) );
  NAND2_X1 U112 ( .A1(s16), .A2(cr15), .ZN(n26) );
  XNOR2_X1 U113 ( .A1(n27), .A2(n26), .ZN(P[6]) );
  XOR2_X1 U114 ( .A1(n29), .A2(n28), .Z(P[7]) );
  XOR2_X1 U115 ( .A1(n31), .A2(n30), .Z(P[8]) );
  XOR2_X1 U116 ( .A1(n33), .A2(n32), .Z(P[9]) );
endmodule
