...
module CSA_Cell_24 ( X, Y, S_in, C_in, S_out, C_out );
  ...
  FA_24 U1 ( .A(And_XY), .B(S_in), .CI(1'b0), .CO(C_out), .S(S_out) );
endmodule
...
module CSA_Cell_16 ( X, Y, S_in, C_in, S_out, C_out );
  ...
  FA_16 U1 ( .A(And_XY), .B(S_in), .CI(C_in), .CO(C_out), .S(S_out) );
endmodule
...
module CSA_Cell_23 ( X, Y, S_in, C_in, S_out, C_out );
  ...
  FA_23 U1 ( .A(And_XY), .B(S_in), .CI(1'b0), .CO(C_out), .S(S_out) );
endmodule
...
module CSA_Cell_22 ( X, Y, S_in, C_in, S_out, C_out );
  ...
  FA_22 U1 ( .A(And_XY), .B(1'b0), .CI(1'b0), .S(S_out) );
endmodule
...
module BAM_V8H2_Mult_8bits ( A, B, P );
  ...
  input [7:0] B;
  output [15:0] P;
  wire   S_26, S_27, S_35, C_35, S_36, C_36, S_37, S_44, C_44, S_45, C_45,
         S_46, C_46, S_47, S_53, C_53, S_54, C_54, S_55, C_55, S_56, C_56,
         S_57, S_62, C_62, S_63, C_63, S_64, C_64, S_65, C_65, S_66, C_66,
         S_67, C_71, S_72, C_72, S_73, C_73, S_74, C_74, S_75, C_75, S_76,
         C_76, S_77, n30, n31, n32, n33, n34, n35, n36, n37, n38, n39, n40,
  ...
  CSA_Cell_26 U22 ( .X(A[2]), .Y(B[6]), .S_in(1'b0), .C_in(1'b0), .S_out(S_26)
         );
  CSA_Cell_25 U23 ( .X(A[2]), .Y(B[7]), .S_in(1'b0), .C_in(1'b0), .S_out(S_27)
         );
  CSA_Cell_24 U29 ( .X(A[3]), .Y(B[5]), .S_in(S_26), .C_in(1'b0), .S_out(S_35), 
        .C_out(C_35) );
  CSA_Cell_23 U30 ( .X(A[3]), .Y(B[6]), .S_in(S_27), .C_in(1'b0), .S_out(S_36), 
        .C_out(C_36) );
  CSA_Cell_22 U31 ( .X(A[3]), .Y(B[7]), .S_in(1'b0), .C_in(1'b0), .S_out(S_37)
         );
  CSA_Cell_21 U36 ( .X(A[4]), .Y(B[4]), .S_in(S_35), .C_in(1'b0), .S_out(S_44), 
        .C_out(C_44) );
  CSA_Cell_20 U37 ( .X(A[4]), .Y(B[5]), .S_in(S_36), .C_in(C_35), .S_out(S_45), 
        .C_out(C_45) );
  CSA_Cell_19 U38 ( .X(A[4]), .Y(B[6]), .S_in(S_37), .C_in(C_36), .S_out(S_46), 
        .C_out(C_46) );
  CSA_Cell_18 U39 ( .X(A[4]), .Y(B[7]), .S_in(1'b0), .C_in(1'b0), .S_out(S_47)
         );
  CSA_Cell_17 U43 ( .X(A[5]), .Y(B[3]), .S_in(S_44), .C_in(1'b0), .S_out(S_53), 
        .C_out(C_53) );
  CSA_Cell_16 U44 ( .X(A[5]), .Y(B[4]), .S_in(S_45), .C_in(C_44), .S_out(S_54), 
        .C_out(C_54) );
  CSA_Cell_15 U45 ( .X(A[5]), .Y(B[5]), .S_in(S_46), .C_in(C_45), .S_out(S_55), 
        .C_out(C_55) );
  CSA_Cell_14 U46 ( .X(A[5]), .Y(B[6]), .S_in(S_47), .C_in(C_46), .S_out(S_56), 
        .C_out(C_56) );
  ...
  INV_X1 U40 ( .I(S_76), .ZN(n39) );
  XOR2_X1 U41 ( .A1(C_73), .A2(S_74), .Z(n45) );
  AOI21_X1 U42 ( .A1(C_71), .A2(S_72), .B(S_73), .ZN(n30) );
  INV_X1 U48 ( .I(S_73), .ZN(n46) );
  NAND2_X1 U49 ( .A1(C_71), .A2(S_72), .ZN(n47) );
  OAI22_X1 U56 ( .A1(C_72), .A2(n30), .B1(n46), .B2(n47), .ZN(n44) );
  AND2_X1 U64 ( .A1(n45), .A2(n44), .Z(n31) );
  AOI21_X1 U65 ( .A1(S_74), .A2(C_73), .B(n31), .ZN(n42) );
  INV_X1 U66 ( .I(n42), .ZN(n33) );
  OR2_X1 U67 ( .A1(S_75), .A2(n33), .Z(n32) );
  AOI22_X1 U68 ( .A1(S_75), .A2(n33), .B1(C_74), .B2(n32), .ZN(n40) );
  AND2_X1 U69 ( .A1(n39), .A2(n40), .Z(n34) );
  OAI22_X1 U70 ( .A1(n39), .A2(n40), .B1(C_75), .B2(n34), .ZN(n37) );
  OR2_X1 U71 ( .A1(C_76), .A2(S_77), .Z(n35) );
  AOI22_X1 U72 ( .A1(C_76), .A2(S_77), .B1(n37), .B2(n35), .ZN(n36) );
  INV_X1 U73 ( .I(n36), .ZN(P[15]) );
  XOR2_X1 U75 ( .A1(C_71), .A2(S_72), .Z(P[9]) );
  XNOR2_X1 U76 ( .A1(S_77), .A2(C_76), .ZN(n38) );
  XNOR2_X1 U77 ( .A1(n38), .A2(n37), .ZN(P[14]) );
  XNOR2_X1 U78 ( .A1(n40), .A2(n39), .ZN(n41) );
  XOR2_X1 U79 ( .A1(n41), .A2(C_75), .Z(P[13]) );
  XNOR2_X1 U80 ( .A1(n42), .A2(S_75), .ZN(n43) );
  XOR2_X1 U81 ( .A1(n43), .A2(C_74), .Z(P[12]) );
  XOR2_X1 U82 ( .A1(n45), .A2(n44), .Z(P[11]) );
  XOR2_X1 U83 ( .A1(n46), .A2(C_72), .Z(n48) );
  XNOR2_X1 U84 ( .A1(n48), .A2(n47), .ZN(P[10]) );
endmodule
