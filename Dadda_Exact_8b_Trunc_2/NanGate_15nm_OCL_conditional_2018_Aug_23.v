...
module AOI22_X1 (A1, A2, B1, B2, ZN);
  ...
  specify
    if((A2 & ~B1 & ~B2)) (A1 => ZN) = (0.1, 0.1);
    if((A2 & ~B1 & B2)) (A1 => ZN) = (0.1, 0.1);
    if((A2 & B1 & ~B2)) (A1 => ZN) = (0.1, 0.1);
    if((A1 & ~B1 & ~B2)) (A2 => ZN) = (0.1, 0.1);
    if((A1 & ~B1 & B2)) (A2 => ZN) = (0.1, 0.1);
    if((A1 & B1 & ~B2)) (A2 => ZN) = (0.1, 0.1);
    if((~A1 & ~A2 & B2)) (B1 => ZN) = (0.1, 0.1);
    if((~A1 & A2 & B2)) (B1 => ZN) = (0.1, 0.1);
    if((A1 & ~A2 & B2)) (B1 => ZN) = (0.1, 0.1);
    if((~A1 & ~A2 & B1)) (B2 => ZN) = (0.1, 0.1);
    if((~A1 & A2 & B1)) (B2 => ZN) = (0.1, 0.1);
    if((A1 & ~A2 & B1)) (B2 => ZN) = (0.1, 0.1);
  endspecify
