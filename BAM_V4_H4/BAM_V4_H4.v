...
module CSA_Cell_31 ( X, Y, S_in, C_in, S_out, C_out );
  ...
  FA_31 U1 ( .A(And_XY), .B(1'b0), .CI(1'b0), .S(S_out) );
endmodule
...
module CSA_Cell_30 ( X, Y, S_in, C_in, S_out, C_out );
  ...
  FA_30 U1 ( .A(And_XY), .B(1'b0), .CI(1'b0), .S(S_out) );
endmodule
...
module CSA_Mult_8bits ( A, B, P );
  ...
  input [7:0] B;
  output [15:0] P;
  wire   S_41, S_42, S_43, S_44, S_45, S_46, S_47, C_50, S_51, C_51, S_52,
         C_52, S_53, C_53, S_54, C_54, S_55, C_55, S_56, C_56, S_57, C_60,
         S_61, C_61, S_62, C_62, S_63, C_63, S_64, C_64, S_65, C_65, S_66,
         C_66, S_67, C_70, S_71, C_71, S_72, C_72, S_73, C_73, S_74, C_74,
         S_75, C_75, S_76, C_76, S_77, n29, n30, n31, n32, n33, n34, n35, n36,
  ...
  CSA_Cell_31 U32 ( .X(A[4]), .Y(B[0]), .S_in(1'b0), .C_in(1'b0), .S_out(P[4])
         );
  CSA_Cell_30 U33 ( .X(A[4]), .Y(B[1]), .S_in(1'b0), .C_in(1'b0), .S_out(S_41)
         );
  CSA_Cell_29 U34 ( .X(A[4]), .Y(B[2]), .S_in(1'b0), .C_in(1'b0), .S_out(S_42)
         );
  CSA_Cell_28 U35 ( .X(A[4]), .Y(B[3]), .S_in(1'b0), .C_in(1'b0), .S_out(S_43)
         );
  CSA_Cell_27 U36 ( .X(A[4]), .Y(B[4]), .S_in(1'b0), .C_in(1'b0), .S_out(S_44)
         );
  CSA_Cell_26 U37 ( .X(A[4]), .Y(B[5]), .S_in(1'b0), .C_in(1'b0), .S_out(S_45)
         );
  CSA_Cell_25 U38 ( .X(A[4]), .Y(B[6]), .S_in(1'b0), .C_in(1'b0), .S_out(S_46)
         );
  CSA_Cell_24 U39 ( .X(A[4]), .Y(B[7]), .S_in(1'b0), .C_in(1'b0), .S_out(S_47)
         );
  CSA_Cell_23 U40 ( .X(A[5]), .Y(B[0]), .S_in(S_41), .C_in(1'b0), .S_out(P[5]), 
        .C_out(C_50) );
  ...
  INV_X1 U67 ( .I(C_74), .ZN(n29) );
  AND2_X1 U69 ( .A1(S_71), .A2(C_70), .Z(n31) );
  XNOR2_X1 U70 ( .A1(S_72), .A2(n31), .ZN(n30) );
  XNOR2_X1 U71 ( .A1(n30), .A2(C_71), .ZN(P[9]) );
  XOR2_X1 U72 ( .A1(S_71), .A2(C_70), .Z(P[8]) );
  INV_X1 U73 ( .I(S_77), .ZN(n41) );
  INV_X1 U74 ( .I(S_75), .ZN(n46) );
  AND3_X1 U75 ( .A1(S_71), .A2(C_70), .A3(C_71), .Z(n32) );
  OAI22_X1 U76 ( .A1(S_72), .A2(n32), .B1(n31), .B2(C_71), .ZN(n52) );
  INV_X1 U77 ( .I(n52), .ZN(n34) );
  AND2_X1 U78 ( .A1(n34), .A2(C_72), .Z(n33) );
  OAI22_X1 U79 ( .A1(n34), .A2(C_72), .B1(S_73), .B2(n33), .ZN(n50) );
  INV_X1 U80 ( .I(n50), .ZN(n36) );
  INV_X1 U81 ( .I(C_73), .ZN(n49) );
  AND2_X1 U82 ( .A1(n36), .A2(S_74), .Z(n35) );
  OAI22_X1 U83 ( .A1(n36), .A2(S_74), .B1(n49), .B2(n35), .ZN(n47) );
  AND2_X1 U84 ( .A1(n46), .A2(n47), .Z(n37) );
  OAI22_X1 U85 ( .A1(n46), .A2(n47), .B1(C_74), .B2(n37), .ZN(n44) );
  AND2_X1 U86 ( .A1(n44), .A2(S_76), .Z(n39) );
  OR2_X1 U87 ( .A1(n44), .A2(S_76), .Z(n38) );
  OAI21_X1 U88 ( .A1(C_75), .A2(n39), .B(n38), .ZN(n42) );
  OR2_X1 U89 ( .A1(n41), .A2(n42), .Z(n40) );
  AOI22_X1 U90 ( .A1(n41), .A2(n42), .B1(C_76), .B2(n40), .ZN(P[15]) );
  XOR2_X1 U91 ( .A1(n41), .A2(C_76), .Z(n43) );
  XNOR2_X1 U92 ( .A1(n43), .A2(n42), .ZN(P[14]) );
  XNOR2_X1 U93 ( .A1(n44), .A2(S_76), .ZN(n45) );
  XNOR2_X1 U94 ( .A1(n45), .A2(C_75), .ZN(P[13]) );
  XOR2_X1 U95 ( .A1(n47), .A2(n46), .Z(n48) );
  XOR2_X1 U96 ( .A1(n48), .A2(n29), .Z(P[12]) );
  XNOR2_X1 U97 ( .A1(n50), .A2(n49), .ZN(n51) );
  XOR2_X1 U98 ( .A1(n51), .A2(S_74), .Z(P[11]) );
  XOR2_X1 U99 ( .A1(n52), .A2(C_72), .Z(n53) );
  XNOR2_X1 U100 ( .A1(n53), .A2(S_73), .ZN(P[10]) );
endmodule
